				...
				<div class="panel panel-default">
					<div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
						<div class="panel-body meus">
							<ul id="navigation">
                <li data-price="aaaa" class="refendable11 <?php if($activedata["activemain"] == "dashboard"){ echo "active";} ?>">
                                       ...
                                       if($this->session->userdata("DsaStafflogin") != NULL)
                                         {
                                           if(in_array($allmenus["menu_module_name"], $dsaStaffmenu)) 
                                             { 
                          ?>
                                                <li  data-price="<?php echo $allmenus["menu_title"];?>" class="refendable11 <?php if($activedata["activemain"] == $allmenus['menu_active_class']){ echo "active";} ?>">
                                                <a role="button" tabindex="0">
                                                  <i class="fa <?php echo $allmenus['menu_icon']; ?>"></i> 
                                                  <span><?php echo $allmenus["menu_title"];?></span>
                                                </a>
