					  				...
					  				<div class="row">
					  					<div class="col-md-6">
				  							<div class="form-group">
				  								...
				  								<select id="package" class="form-control custom-select" name="tour_type">
												<option value="">Any</option>
												<?php
													$sub_category = $this->all_sub_category;
													if(isset($sub_category) && $sub_category!="not") {
													?>
													<?php foreach ($sub_category as  $sc) { ?>
				  									<option value="<?php echo $sc->holsubc_id; ?>"><?php echo $sc->holsubc_name; ?></option>					
													 <?php  }?>  
												<?php } ?>  
