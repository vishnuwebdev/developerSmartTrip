					...
					<div class="collapse navbar-collapse justify-content-center" id="navbarsExample03">
				        <ul class="navbar-nav">	
				        	<!-- <li class="nav-item">
				          	...
				          	<li class="nav-item">
				            	<a class="nav-link <?php if($active_tab=="holiday") { echo "active";} ?>" href="<?php echo site_url();?>?type=holiday"><i class="icofont-beach"></i> Holiday </a>
				          	</li>
		 	...
		 	<div class="col-lg-5 col-md-5 order-1 order-md-3">
		 		<div class="header-right-wrap text-center text-md-right ">
		 			<ul class="list-inline mb-0">
						...
						<?php }else { ?>
						 <li class="list-inline-item">
						 	<a class="pl-0" href="javascript:void(0)"><strong>Wallet Balance : </strong><?php echo $this->user_data->cust_balance; ?></a>
						 </li>
						 <!--
