	...
	<div class="container-fluid">
			 	...
			 	<div class="user-sidebar-wrapper pt-2 pt-md-5">
			 		<div class="inner-user-paul">
			 				...
			 				<div class="row">
			 					<div class="col-md-6">
			 						<div class="card-head-top">
			 							<h1 class="mb-0"><i class="icofont-rupee-plus"></i> Add Wallet</h1>
			 						</div>
			 					</div>
			 					<div class="col-md-6">
			 						...
			 						<div class="breadcrumb-col">
			 							<ul class="list-inline mb-0 breadcrumb">
			 								<li class="list-inline-item mr-0 breadcrumb-item">
						                  	...
						                  	<li class="list-inline-item mr-0 breadcrumb-item">Add Wallet</li>
						                </ul>
						              </div>
			 					</div>
			 				</div>
			 			...
			 			<div class="paul-card-content">
			 				<div class="clearfix">
	    <?php	    
	      if ($this->session->flashdata('bal_alert') != NULl) {
	      $bhanu_message = $this->session->flashdata('bal_alert')['message'];
	      ?>
	  ...
	  <?php } ?>
			 				...
			 				<div class="paul-layout">
			                    ...
			                    <h4 class="htl-title">Add Wallet</h4>
							  ...
							  <div class="row">
			                      ...
			                      <div class="col-md-4">
			                        <div class="form-group">
			                         ...
			                         <input type="text" name="description" id="cheque-issue-date" class="form-control" value="Add money into Wallet" required="">
			                        </div>
			                      </div>
								   <div class="col-md-4">
			                         <div class="form-group">
