...
foreach ($FBookingList as $Listing) { ?>
    ...
    <?php } ?></td>
                                                <td>Rs. 
													...
													<?php 
														$flight_amount = $Listing['booklist']->fbook_customer_fare + $Listing['booklist']->fbook_ib_customer_fare ; 
														$transaction_fee_amount = $Listing['booklist']->fbook_transaction_fee ; 
														 echo $flight_amount +  $transaction_fee_amount;
													?>
