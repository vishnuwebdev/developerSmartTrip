...
<section class="flght-booking-details pt-2 pb-2 pt-md-4 pb-md-4">
                                    ...
                                    <div class="col-sm-12 col-md-12 mb-10">
                                        <div class="rew-htl-topbar">
                                            <ul class="list-unstyled">
                                                <li class="mb-1"><span><strong>Welcome </strong>
                                                        <?php print_r($bp_hotel_detail->HotelName) ?> </span></li>
                                                <li>
                                                    <span><strong><i class="icofont-google-map"></i> Address
                                                            :</strong></span><?php echo $bp_hotel_detail->Address;?>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="com-chtl">
                                                        ...
                                                        <p class="mb-0">
                                                            <?php echo date_format(date_create($bp_hotel_result->HotelSearchResult->CheckInDate),"D, d M Y");?>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="com-chtl">
                                                        ...
                                                        <p class="mb-0">
                                                            <?php echo $_SESSION ['hotel'] ['array'] ['search_request']['NoOfNights']?>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="com-chtl">
                                                        ...
                                                        <p class="mb-0">
                                                            <?php echo date_format(date_create($bp_hotel_result->HotelSearchResult->CheckOutDate),"D, d M Y");?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <form id="id_from" action="<?php echo site_url(); ?>hotel/save_booking_data" method="post">
                        ...
                        <div class="trvl-details">
                                ...
                                <div class="flt-booking-dts">
                                    <div class="col-fly-inn">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-group custom-select-wrap">
                                                    <select
                                                        class="form-control custom-select pax_validation_field full white-bg"
                                                        name="title_adult_<?php echo $bp_pax_key;?>_<?php echo $i;?>">
                                                        <option>Mr</option>
                                                        <option>Mrs</option>
                                                        <option>Miss</option>
                                                        <option>Ms</option>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text"
                                                        name="first_name_adult_<?php echo $bp_pax_key;?>_<?php echo $i;?>"
                                                        class=" form-control pax_validation_field name_valid full white-bg"
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text"
                                                        name="last_name_adult_<?php echo $bp_pax_key;?>_<?php echo $i;?>"
                                                        class="form-control pax_validation_field name_valid full white-bg"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text" name="pan_adult_<?= $bp_pax_key ?>_<?= $i ?>"
                                                        class="form-control pax_validation_field name_valid full white-bg"
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text"
                                                        name="passport_adult_<?= $bp_pax_key ?>_<?= $i ?>"
                                                        class="form-control pax_validation_field name_valid full white-bg"
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text"
                                                        name="passport_exp_adult_<?= $bp_pax_key ?>_<?= $i ?>"
                                                        class="form-control pax_validation_field name_valid full white-bg"
                                        ...
                                        <label>Child <?php echo $bp_key_child+1;?> (Age -
                                            <?php echo $bp_child_pax_data;?>) -</label>
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-group custom-select-wrap">
                                                    <select class="form-control custom-select full white-bg"
                                                        name="title_child_<?php echo $bp_pax_key;?>_<?php echo $bp_key_child;?>">
                                                        <option>Mstr</option>
                                                        <option>Miss</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text"
                                                        name="first_name_child_<?php echo $bp_pax_key;?>_<?php echo $bp_key_child;?>"
                                                        class="form-control pax_validation_field name_valid full white-bg"
                                                        placeholder="Enter First Name" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text"
                                                        name="last_name_child_<?php echo $bp_pax_key;?>_<?php echo $bp_key_child;?>"
                                                        class="form-control name_valid pax_validation_field full white-bg"
                                                        placeholder="Enter Last Name" />
                                                    <input type="hidden" value="<?php echo $bp_child_pax_data;?>"
                                                        name="age_child_<?php echo $bp_pax_key;?>_<?php echo $bp_key_child;?>"
                                                        class="full white-bg" />
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="trv-topbar mb-3">
                                ...
                                <?php
								$email = isset($loginuser->cust_email) ? $loginuser->cust_email : null;
								$mobile = isset($loginuser->cust_mobile) ? $loginuser->cust_mobile : null;
							?>
                                <div class="flt-booking-dts">
                                    <div class="col-fly-inn">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?= $email ?>" id="email_valid"
                                                        name="cust_email"
                                                        class="form-control pax_validation_field full white-bg" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" value="<?= $mobile ?>" name="mobile"
                                                        class="phone form-control pax_validation_field full white-bg" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="trv-topbar mb-3 htl-policy-desc">
                                ...
                                <div class="flt-booking-dts">
                                    ...
                                    <div class="col-fly-inn">
                                        <a class="room-type" href="#" title="Room 1 Smart Deluxe Room">Room
                                            <?php echo $bp_room_detail_key+1;?> -
                                            <?php echo $bp_hotel_block_results->RoomTypeName;?></a>
                            ...
                            <div class="trv-topbar mb-3">
								...
								?>
                                        <div class="col-md-12">
                                            <div class="checkbox">
                                                <label>
                                                    <input name="wallet_amount" class="term_condition" type="checkbox"
                                                        value="customerCash">
								...
								?>
                                        <div class="col-md-12">
                                            <div class="checkbox">
                                                <label>
                                                    <input name="payment_method" class="payment_option" checked
                                                        type="radio"
                                                        value="<?php echo $getwayLists->dsapayg_gateway_name; ?>">
                                                ...
                                                <br />
                                                <span class="">
                                                    <?= $symbol ?> <?php echo $final_con ?> Convenience Fee (Will be
                                                    included in total fare at the time of payment)
                                                </span>
                                                <?php 
									...
									-->
                                        ...
                                        <div class="checkbox htl-srch-rtng">
                                            <label for="terms">
                                                <input type="checkbox" id="terms" class="flightfare"
                                                    value="NonRefundable">
                                                <span>
                                                    I have read and accept the <a target="blank"
                                                        href="https://www.smarttripmaker.com/online/terms-and-conditions">
                                                        Terms and Conditions </a> and <a target="blank"
                                                        href="https://www.smarttripmaker.com/online/privacy-policy">Privacy
                                                        Policy</a>.
                                                </span>
                                            </label>
                                        </div>
                                        <div class="form-group text-md-right">
                                            <button type="button"
                                                class="btn btn-search booking_btn bookingbtnsubmit btn-com bp_hotel_info_find"
                                                id="id_btn">Complete Booking </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="flght-side-det">
                    ...
                    <div class="contant">
                        <ul class="fare_details list-unstyled mb-0">
                            <li>Base Fare <span class="float-right"><?= $symbol ?>
                                    <?php echo round($bp_base_price); ?></span></li>
                            <li>Tax (+)<span class="float-right"><?= $symbol ?> <?php echo round($bp_tax); ?></span>
                            </li>
                            <?php if($getwayList!="0"){
								// $getwayLists = $getwayList[0];					
								// if($getwayLists->dsapayg_type = "fix"){
								...
								// }
							?>
                            <li>Convenience Fee<span class="float-right"><?= $symbol ?> <?php echo $final_con; ?></span>
                            </li>

                            <?php }else { $final_con = 0; }  $_SESSION['hotel']['amount']['final_con'] = $final_con; ?>

                            <li>Total Fare<span class="float-right final_fare"><?= $symbol ?>
                                    <?php echo round($bp_customer_price+$final_con); ?></span></li>
                        </ul>
                    </div>
                    <!-- Apply Coupon -->
                    <div class="flght-side-det">
                        ...
                        <div class="contant">
                            ...
                            <div class="apply-coupoun text-center">
                                <div class="form-group">
                                    <input type="text" id="user_coupon" name="coupon" class="form-control"
    ...
    <div class="modal fade confirmpop " id="Modal_for_confirm" tabindex="-1" role="dialog"
    ...
    <div id="hotel_confirm_pop_up" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel1111" aria-hidden="true">
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (obj.status == "success") {
                ...
                $('.coupon').show();
                $('.coupon').append(
                    "Coupon Discount (-) <span class='float-right'> <?= $js_currency_symbol ?> " +
                    parseInt(obj.discount_amount) + "</span>");
            } else {
                $("#loader").modal('hide');
                $('#massegealert').html(obj.message);
