...
$seatData = isset($BookingDetails->fbook_ob_seat) ? json_decode($BookingDetails->fbook_ob_seat) : null;
?>
<html lang="en">
<head>
	<meta charset="UTF-8">
							...
							<tbody>
							 ...
							 foreach ($SelectedFare->Response->Response->FlightItinerary->Passenger as $PaxDetails_lop){ ?>
								<tr>
									...
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"><?= isset($seatData[$i]) ? $seatData[$i]  : '' ?></td>
									...
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"><?= $currency ?> <?php echo isset($BookingDetails->fbook_baggage_amount) ? $BookingDetails->fbook_baggage_amount : '-'; ?></td>
					...
					<td colspan="2" style="padding-bottom: 15px;">
						<table style="width: 800px;min-width: 100%; border-spacing: 0px;border-collapse: collapse;border:1px solid #000;">
							<tr>
								...
								<td style="padding: 6px;"><?= $currency ?> <?php echo round($BookingDetails->fbook_customer_fare);?></td>
							</tr>
						</table>
					</td>
				</tr>
