...
<section class="flght-booking-details pt-2 pb-2 pt-md-4 pb-md-4">
	<div class="container">
		...
		<div class="thankyou-confrim">
			...
			<p class="mb-0">Thank You. Your Booking Id : STM0000<?php echo $BookingDetails->fbook_id; ?>  is Confirmed Now.</p>
				...
				<div class="flght-booking-left-col flght-booking-confrim-temp">
					...
					<div class="flt-booking-wrap mb-2 mb-md-3">
						<div class="flt-booking-top">
							<div class="row">
								<div class="col-md-8">
									<h5>Flight Detail (<b><?php echo $BookingDetails->fbook_depart_city; ?></b> To <b><?php echo $BookingDetails->fbook_arrive_city; ?></b>, depart - <b><?php 
        $dateformat = date_format(date_create($BookingDetails->fbook_depart_date),"d M Y");
        echo $dateformat; ?> </b> )</h5>
								</div>
								<div class="col-md-4">
							...
							<div class="row flt-booking-dts">
								<div class="col-md-4 col-sm-4 col-6">
									<div class="fl-o-way-com">
										<strong><?php echo $PaxDetails23->fpax_type; ?> -</strong> <?php echo $PaxDetails23->fpax_title; ?> <?php echo $PaxDetails23->fpax_first_name; ?> <?php echo $PaxDetails23->fpax_last_name; ?></strong>
									</div>
								</div>
								<?php if(isset($PaxDetails23->fpax_seat_code) && !empty($PaxDetails23->fpax_seat_code)){?>
									<div class="col-md-4 col-sm-4 col-6">
										<div class="dep-dr fl-o-way-com txt-right">
											<!-- <i class="icofont-school-bag font-22"></i>  -->
											<strong>Seat Code : </strong>
											<?= $PaxDetails23->fpax_seat_code ?>
										</div>
									</div>
								<?php } ?>
								<?php if(isset($PaxDetails23->fpax_baggage_weight) && !empty($PaxDetails23->fpax_baggage_weight)){?>
									<div class="col-md-4 col-sm-4 col-6">
										<div class="dep-dr fl-o-way-com txt-right">
											...
											<?php echo ($PaxDetails23->fpax_baggage_weight) ? $PaxDetails23->fpax_baggage_weight. 'KG' : ''; ?>
										</div>
									</div>
								<?php } ?>
				...
				<div class="flght-side-det">
		            ...
		            <div class="contant">
		            	<ul class="fare_details list-unstyled mb-0">
		            		...
		            		<li>Tax (+)<span class="float-right"><i class="icofont-rupee"></i>

		            			<?php  $baggage =  isset($BookingDetails->fbook_baggage_amount) ? $BookingDetails->fbook_baggage_amount : 0;
		            				$meal =  isset($BookingDetails->fbook_meals_amount) ? $BookingDetails->fbook_meals_amount : 0;
		            			 ?>




		            		 <?php echo round($BookingDetails->fbook_customer_fare + $BookingDetails->fbook_transaction_fee - $SelectedFare->Response->Response->FlightItinerary->Fare->BaseFare - $baggage - $meal ); ?></span></li>

		            		<li>Baggage <span class="float-right"><?php echo isset($BookingDetails->fbook_baggage_amount) ? $BookingDetails->fbook_baggage_amount : '-'; ?></span></li>

		            		<li>Meal & Bavrage <span class="float-right"><?php echo isset($BookingDetails->fbook_meals_amount) ? $BookingDetails->fbook_meals_amount : '-'; ?></span></li>



		            		<li>Total Fare<span class="float-right"><i class="icofont-rupee"></i><?php echo round($BookingDetails->fbook_customer_fare + $BookingDetails->fbook_transaction_fee); ?></span></li>
		            	</ul>
		            </div>
		        </div>
