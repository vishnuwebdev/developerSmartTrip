...
<body style="background-color:#eeeeee;padding: 25px 0px;" class="remove-css">
			...
			<tbody>
				<tr>
					<td style="border:0px none;">
						...
						<img src="<?php echo site_url();?>/admin/assets/img/logos/<?php echo $this->dsa_data->dsa_logo;?>" alt="logo" style="max-width: 70%;">
						...
						<table style="width: 800px;min-width: 100%; border-spacing: 0px;border-collapse: collapse;border:1px solid #000;">
							<thead>
								<tr>
									...
									<th style="border-left:1px solid #000;padding: 7px 12px;background-color: #d8d8d8;border-bottom: 1px solid #000;border-right: 1px solid #000;">BAGGAGE DETAIL</th>
									<th style="border-left:1px solid #000;padding: 7px 12px;background-color: #d8d8d8;border-bottom: 1px solid #000;border-right: 1px solid #000;">MEAL &  BAVRAGE</th>
									...
									<th style="border-left:1px solid #000; padding: 7px 12px;background-color: #d8d8d8;border-bottom: 1px solid #000;border-right: 1px solid #000;">Seat Code</th>
								</tr>
							</thead>
							<tbody>
							 <?php 
									 ...
									 foreach ($PaxDetails as $PaxDetails_lop){ ?>
								<tr>
									...
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">
										<?php echo isset($PaxDetails_lop->fpax_baggage_weight) ? $PaxDetails_lop->fpax_baggage_weight : '0'; ?> KG 
									</td>

									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">
										<?php echo isset($PaxDetails_lop->fpax_meal_item) ? $PaxDetails_lop->fpax_meal_item : ''; ?>  
									</td>

									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"><?php echo isset($BookingDetails->fbook_ob_pnr) ? $BookingDetails->fbook_ob_pnr : ''; ?></td>

									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"> <?php echo isset($BookingDetails->fbook_ob_booking_id) ? $BookingDetails->fbook_ob_booking_id : ''; ?></td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"> 
										<?= isset($PaxDetails_lop->fpax_seat_code) ? $PaxDetails_lop->fpax_seat_code : '' ?>
									</td>
								</tr>
							  <?php } ?>
							</tbody>
							 ...
							 ?>
								<tr>
									<td style="padding: 7px 12px;border-right: 1px solid #000;">
										...
										<p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0; font-weight:normal;  "> <?php echo $segmentloop->Airline->AirlineName; ?> <b><?php echo $segmentloop->Airline->AirlineCode; ?>-<?php echo $segmentloop->Airline->FlightNumber; ?></b></p></td>
									<td style="padding: 7px 12px;border-right: 1px solid #000;">
									...
									<td style="padding: 7px 12px;border-right: 1px solid #000;">
										<p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0; font-weight:normal;  ">  <?php echo $segmentloop->Destination->Airport->CityName; ?>  
										<br><?php echo GetDateScFull($segmentloop->Destination->ArrTime); ?> , <?php echo GetTime($segmentloop->Destination->ArrTime); ?>, <br>
				...
				<tr>
					<td colspan="2">
						<table style="width: 800px;min-width: 100%; border-spacing: 0px;border-collapse: collapse;">
							<tbody>
								<tr colspan="2">
									<td colspan="2" style="font-weight:bold;font-size:15px;text-align:center;padding: 7px 12px;background-color: #d8d8d8;border: 1px solid #000;">PAYMENT DETAILS</td>
								</tr>
								<tr>
									...
									<td style="border: 1px solid #000;">
										<table style="width: 100%; border-spacing: 0px;border-collapse: collapse;">
											<tbody>
												...
												<?php  $baggage =  isset($BookingDetails->fbook_baggage_amount) ? $BookingDetails->fbook_baggage_amount : 0 ?>


												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;    border-bottom: 1px solid #000;">TAX AND ADDITIONAL CHARGE (+):</td>
													<td style="padding: 7px 12px;    border-bottom: 1px solid #000;"><?php echo round($BookingDetails->fbook_customer_fare + $BookingDetails->fbook_transaction_fee - $SelectedFare->Response->Response->FlightItinerary->Fare->BaseFare - $baggage); ?> </td>
												</tr>

												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;    border-bottom: 1px solid #000;">BAGGAGE Charge: <?php echo isset($BookingDetails->fbook_baggage_weight) ? $BookingDetails->fbook_baggage_weight.' KG'  : '-'; ?></td>
													<td style="padding: 7px 12px;    border-bottom: 1px solid #000;"><?php echo isset($BookingDetails->fbook_baggage_amount) ? $BookingDetails->fbook_baggage_amount : '-'; ?></td>
												</tr>
												
												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;">TOTAL AIR FARE:</td>
													<td style="padding: 7px 12px;"><?php echo round($BookingDetails->fbook_customer_fare + $BookingDetails->fbook_transaction_fee); ?></td>
												</tr>
											</tbody>
										</table>
									</td>
	...
	<?php }?>	
			<?php 
			echo "<pre>";
			print_r($SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Weight);
			 ?>
		</div>
