							...
							<tr>
								...
								<td style="border-top: 1px solid #000;border-bottom: 1px solid #000;border-right: 1px solid #000; padding: 8px;">
									<table style="width: 100%; border-spacing: 0px;border-collapse: collapse;">
										<tbody>
											<tr><td>Airline PNR:</td><td><strong><?php echo $BookingDetails->fbook_ob_pnr; ?></strong></td></tr>
				...
				<tr>
					<td colspan="2" style="padding-bottom: 15px;">
						<table style="width: 800px;min-width: 100%; border-spacing: 0px;border-collapse: collapse;">
							<thead>
								<tr>
								<th style="border:1px solid #000;padding: 7px 12px;background-color: #d8d8d8;border-bottom: 1px solid #000;width: 63%;">Company GST Details</th>
								<?php							
								if ($this->session->userdata ( 'Userlogin' ) != NULL) {								
								?>
								<th style="border-left: none;padding: 7px 12px;background-color: #d8d8d8;border: 1px solid #000;">Customer GST Details</th>
							<?php } else{?>
							<?php }?>
								</tr>
							</thead>
							<tbody>
							<tr>
							<td style="padding:0px;border: 1px solid #000;width: 70%">
							...
							<td style="border: 1px solid #000;padding: 0;vertical-align: text-bottom;width: 30%">
								<table style="min-width: 100%; border-spacing: 0px;">
									<tr>
										<td style="padding: 7px 12px;border-bottom: 1px solid #000;">
					...
					<td colspan="2" style="padding-bottom: 15px;">
						<table style="width: 800px;min-width: 100%; border-spacing: 0px;border-collapse: collapse;border:1px solid #000;">
							...
							<tbody>
							 ...
							 foreach ($SelectedFare->Response->Response->FlightItinerary->Passenger as $PaxDetails_lop){ ?>
								<tr>
									...
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"> <?php echo $BookingDetails->fbook_depart_airport_code; ?> -> <?php echo $BookingDetails->fbook_arrive_airport_code; ?>
									</td>
									...
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo $PaxDetails_lop->Fare->BaseFare; ?></td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo round($PaxDetails_lop->Fare->YQTax); ?></td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo $BookingDetails->fbook_customer_fare - ($PaxDetails_lop->Fare->BaseFare + round($PaxDetails_lop->Fare->YQTax)); ?></td>

									<!-- td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php //echo ($SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Price) ? $SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Price : 0; ?></td -->

									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo round($BookingDetails->fbook_customer_fare);?></td>
								</tr>
								<?php } ?>
							</tbody>
					...
					<td colspan="2" style="padding-bottom: 15px;">
						<table style="width: 800px;min-width: 100%; border-spacing: 0px;border-collapse: collapse;border:1px solid #000;">
							<tr>
								...
								<td style="padding: 6px;">INR <?php echo round($BookingDetails->fbook_customer_fare);?></td>
							</tr>
						</table>
					</td>
				</tr>
