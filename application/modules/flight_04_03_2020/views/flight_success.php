							...
							<div class="flt-booking-dts">
							 <?php foreach ($PaxDetails as $PaxDetails23){ ?>
								<div class="col-fly-inn">
									<p class="mb-0"><strong><?php echo $PaxDetails23->fpax_type; ?> -</strong> <?php echo $PaxDetails23->fpax_title; ?> <?php echo $PaxDetails23->fpax_first_name; ?> <?php echo $PaxDetails23->fpax_last_name; ?></p>
								</div>
								<?php } ?>
							</div>
						</div>
				...
				<div class="flght-side-det">
		            ...
		            <div class="contant">
		            	<ul class="fare_details list-unstyled mb-0">
		            		...
		            		<li>Tax (+)<span class="float-right"><i class="icofont-rupee"></i> <?php echo round($BookingDetails->fbook_customer_fare + $BookingDetails->fbook_transaction_fee - $SelectedFare->Response->Response->FlightItinerary->Fare->BaseFare); ?></span></li>

		            		<!-- li>Baggage <?php //echo ($SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Weight) ? $SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Weight.' KG'  : 0; ?>  <span class="float-right"><i class="icofont-rupee"></i> <?php //echo ($SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Price) ? $SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Price : 0; ?></span></li -->
