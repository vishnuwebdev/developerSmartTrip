									...
									<td style="border: 1px solid #000;">
										<table style="width: 100%; border-spacing: 0px;border-collapse: collapse;">
											<tbody>
												...
												<!--tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;    border-bottom: 1px solid #000;">BAGGAGE Charge: <?php //echo isset($SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Weight) ? $SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Weight.' KG' : ''; ?></td>
													<td style="padding: 7px 12px;    border-bottom: 1px solid #000;"><?php // echo isset($SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Price) ? $SelectedFare->Response->Response->FlightItinerary->Passenger[0]->Baggage[0]->Price : ''; ?></td>
												</tr -->
												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;    border-bottom: 1px solid #000;">TAX AND ADDITIONAL CHARGE (+):</td>
													<td style="padding: 7px 12px;    border-bottom: 1px solid #000;"><?php echo round($BookingDetails->fbook_customer_fare + $BookingDetails->fbook_transaction_fee - $SelectedFare->Response->Response->FlightItinerary->Fare->BaseFare); ?> </td>
												</tr>
												<tr>
