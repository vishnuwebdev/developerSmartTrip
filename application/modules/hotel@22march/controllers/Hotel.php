	...
	public function block_room() {
		...
		foreach ( $bp_room_data as $bp_room_datas ) {
			if (in_array ( $bp_room_datas->RoomIndex, $bp_selected_room_index )) {
				...
				// // $bp_select_room_array ["Price"]->ServiceTax = $bp_select_room_array ["Price"]->ServiceTax; //isset($bp_select_room_array ["Price"]->ServiceTax) ? number_format($bp_select_room_array ["Price"]->ServiceTax,2): null;
